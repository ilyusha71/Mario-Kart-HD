...
public class DetachablePartEditor extends Editor
{
	...
	{
		var targetScript : DetachablePart = target as DetachablePart;
		...
		if (showHandles && targetScript.gameObject.activeInHierarchy)
		{
			...
			{
				for (var curJoint : PartJoint in targetScript.joints)
				{
